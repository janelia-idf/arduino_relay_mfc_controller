...
from arduino_relay_mfc_controller import ArduinoRelayMfcController
from arduino_relay_mfc_controller import isArduinoRelayMfcControllerPortInfo
...
def index():
    ...
    return flask.render_template('relay_mfc_controller.html')
